    ...
    return (
        <div className="bento-grid">
            ...
            <div className="bento-item-wide glass-card p-10 rounded-2xl hover-glow transition-all relative overflow-hidden group bg-white border border-black/5">
                <div className="absolute inset-0 opacity-5 group-hover:scale-105 transition-transform duration-700 bg-[url('https://www.sharobakery.co.za/hero-bg.jpg')] bg-cover bg-center" />
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="text-center md:text-left">
                        ...
                        <h3 className="text-2xl font-bold mb-2 font-heading text-primary">Sharo Bakery</h3>
                    ...
                    <Link href="https://www.sharobakery.co.za" target="_blank" className="px-6 py-3 glass-button text-primary rounded-xl font-bold transition-all">
                        Visit Live Site
                    </Link>
                </div>
            </div>
